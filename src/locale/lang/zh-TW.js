export default {
  ...
  library: {
    ...
    cloudDisk: '雲端硬碟',
    newPlayList: '新增歌單',
    importExternalPlaylist: '匯入外部歌單',
    importPlaylistNamePlaceholder: '匯入後的歌單名稱',
    importParseButton: '解析',
    importConfirmButton: '匯入',
    importEmptyInput: '請先貼上歌單連結或分享文字',
    importNoTracks: '目前沒有可匯入的曲目，請先解析',
    importParsedTitle: '歌單',
    importParsedCount: '共 {count} 首曲目',
    importMoreTracks: '還有 {count} 首未顯示',
    importMatchingProgress: '比對中 {matched} / {total}',
    importCreateFailed: '建立歌單失敗，請稍後重試',
    importSuccess: '匯入完成，共比對 {matched} / {total} 首',
    uploadSongs: '上傳音樂',
    playHistory: {
      title: '聽歌排行',
      week: '最近一周',
  ...
  login: {
    ...
    notice: `YesPlayMusic 承諾不會保存您的任何帳戶資訊到雲端。<br />
        ...
        <a href="https://github.com/atri1011/YesPlayMusic"
  ...
  player: {
    ...
    sortNewest: '最新',
    loadMore: '載入更多',
    noMoreComments: '沒有更多評論了',
    noComments: '還沒有評論，快來搶沙發',
    reply: '回覆',
    replyTo: '回覆 @',
    sendComment: '送出',
    commentPlaceholder: '說點什麼吧…',
    commentSuccess: '評論成功',
    commentFailed: '評論失敗',
    likeComment: '點讚',
    unlikeComment: '取消點讚',
