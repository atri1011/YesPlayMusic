export default {
  ...
  library: {
    ...
    cloudDisk: '云盘',
    newPlayList: '新建歌单',
    importExternalPlaylist: '导入外部歌单',
    importPlaylistNamePlaceholder: '导入后的歌单名称',
    importParseButton: '解析',
    importConfirmButton: '导入',
    importEmptyInput: '请先粘贴歌单链接或分享文本',
    importNoTracks: '当前没有可导入的曲目，请先解析',
    importParsedTitle: '歌单',
    importParsedCount: '共 {count} 首曲目',
    importMoreTracks: '还有 {count} 首未显示',
    importMatchingProgress: '匹配中 {matched} / {total}',
    importCreateFailed: '创建歌单失败，请稍后重试',
    importSuccess: '导入完成，共匹配 {matched} / {total} 首',
    uploadSongs: '上传歌曲',
    playHistory: {
      title: '听歌排行',
      week: '最近一周',
